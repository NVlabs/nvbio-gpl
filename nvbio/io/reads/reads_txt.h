...
struct ReadDataFile_TXT : public ReadDataFile
{
protected:
    ReadDataFile_TXT(const char *read_file_name,
...
struct ReadDataFile_TXT_gz : public ReadDataFile_TXT
{
    ReadDataFile_TXT_gz(const char *read_file_name,
...
inline uint8 ReadDataFile_TXT::get(void)
{
